export default {
    ...
    settings_cub_sync_descr: 'Синхронизация с сервисом {account_service}: синхронизация ваших закладок, истории просмотров, меток и тайм-кодов.',
    ...
    settings_cub_sync_btn_descr: 'Сохранить локальные закладки в аккаунт {account_service}',
    ...
    account_create: 'Откройте больше возможностей с аккаунтом {account_service}. Зарегистрируйтесь на сайте <span class="account-modal__site">{site}</span> и получите доступ к синхронизации ваших закладок, тайм-кодов и других возможностей аккаунта {account_service}.',
    account_premium: 'Полный доступ {premium_service} уже включен. Все возможности синхронизации и расширенные функции доступны без дополнительных ограничений.',
    account_premium_more: 'Подробнее о {premium_service}',
    account_limited: 'Ограничение недоступно для {premium_service}. Если вы видите это сообщение, проверьте настройки аккаунта и вашего сервера.',
    ...
    account_qr_premium: 'Отсканируйте QR-код, чтобы узнать больше о {premium_service}',
    ...
    ai_search_limit: 'Лимит запросов превышен. Попробуйте повторить запрос позже. В режиме {premium_service} лимиты выше, поэтому проверьте настройки вашего сервера.',
    ai_subscribe_title: 'Откройте бошьше возможностей с AI',
    ai_subscribe_descr: 'Режим {premium_service} увеличивает лимиты запросов к AI. Вместе с AI мы подберем вам лучшие фильмы, которые только сможем.',
    ...
    developer_param_nopremium: 'Отключить {premium_service}',
