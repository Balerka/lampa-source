export default {
    ...
    settings_cub_sync_descr: 'Synchronization with the {account_service} service: synchronization of your bookmarks, browsing history, tags and timecodes.',
    ...
    settings_cub_sync_btn_descr: 'Save local bookmarks to the {account_service} account',
    ...
    account_create: 'Discover more opportunities with a {account_service} account. Register at <span class="account-modal__site">{site}</span> and get access to sync your bookmarks, timecodes, and other {account_service} features.',
    account_premium_more: 'Learn more about {premium_service}',
    account_limited: 'This limit is not used for {premium_service}. If you see this message, check your account settings and backend configuration.',
    ...
    ai_search_limit: 'Request limit exceeded. Please try again later. In {premium_service} mode, limits are higher, so check your backend settings.',
    ai_subscribe_title: 'Unlock More Opportunities with AI',
    ai_subscribe_descr: '{premium_service} increases AI request limits. Together with AI, we’ll find the best movies for you.',
    ...
    account_qr_premium: 'Scan the QR code to learn more about {premium_service}',
    ...
    developer_param_nopremium: 'Disable {premium_service}',
    ...
    account_premium: '{premium_service} full access is already enabled. Sync features and advanced capabilities are available without extra restrictions.',
